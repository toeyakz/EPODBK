...
public class Var {
    ...
    // public static String dbname = Environment.getExternalStorageDirectory().getPath() + "/Android/data/ws.epod/files/DATABASE/EPOD_DB.db";
...
//    public static ArrayList<WorkLineObject> WorkLineSelected = new ArrayList<>();
    ...
    */
    ...
    //public static String host = "http://thaitms.com/tms_msm/";
