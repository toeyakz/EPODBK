        ...
        if (statusReject != 0 || statusComplete != 0 || commentReject != 0 || statusReturn != 0 || commentReturn != 0) {
            ...
            if (statusReturn != 0) {
                if (statusReturn == commentReturn) {
                    ...
                    Toasty.info(InvoiceDeliver_Activity.this, "Please comment return.", Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
            ...
            if (statusReject != 0) {
                if (statusReject == commentReject) {
                    ...
                    Toasty.info(InvoiceDeliver_Activity.this, "Please comment reject.", Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
...
//            }
            ...
            Toasty.info(InvoiceDeliver_Activity.this, "Please select invoice.", Toast.LENGTH_SHORT).show();
            return false;
        }
